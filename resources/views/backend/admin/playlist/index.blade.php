...
<div class="content">
    <div class="container-fluid">
            ...
            <div class="card-header mb-2">
                <div class="d-flex gap-2 my-3">
                    <h4 class="card-title">
                     ...
                     <a href="{{ route('playlistcategory.index')}}" class="btn btn-primary btn-sm ml-4 ">Category Manage</a>
                    <a href="{{ route('playlistmusic.index')}}" class="btn btn-primary btn-sm ml-4 ">Music Manage</a>
                </div>
                @if(session('error'))
        ...
        <div class="card">
            <div class="card-header mb-2">
                <h4 class="my-3">Play-List <span class=""> (add music to category)</span></h4>
